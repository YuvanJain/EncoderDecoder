...
class Encoder(nn.Module):
    ...
    def forward(self, src):
        ...
        # initial decoder hidden state is the final hidden state of the encoder's forward and backward RNNs fed through a linear layer
...
class Decoder(nn.Module):
    ...
    def forward(self, input, hidden, encoder_outputs):
        ...
        # this also means that output == hidden.squeeze(0)
